...
CKEDITOR.editorConfig = function( config )
{
  ...
  config.toolbar_custom = [
    { name: 'document', items: ['Format', 'Undo', 'Bold', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'Underline', 'Link', 'Unlink', 'Image', 'Table', 'HorizontalRule', 'TextColor', 'BGColor', 'Maximize', 'Source']},
  ];
  ...
  config.extraAllowedContent = 'ul(*);li(*);span(*);i(*)';
